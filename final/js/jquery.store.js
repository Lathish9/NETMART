...
(function (jQuery) {
  ...
  jQuery.Shop.prototype = {
    init: function () {
      ...
      this.jQuerycheckoutOrderForm = this.jQueryelement.find(
        "#checkout-order-form"
      ...
      this.jQueryshoppingCartActions = this.jQueryelement.find(
        "#shopping-cart-actions"
      ); // Cart actions links
      this.jQueryupdateCartBtn =
        this.jQueryshoppingCartActions.find("#update-cart"); // Update cart button
      this.jQueryemptyCartBtn =
        this.jQueryshoppingCartActions.find("#empty-cart"); // Empty cart button
      ...
      this.paypalBusinessEmail = "drakenmanji6969@gmail.com"; // Your Business PayPal's account email address
    ...
    deleteProduct: function () {
      ...
      if (self.jQueryformCart.length) {
        ...
        jQuery(document).on("click", ".pdelete a", function (e) {
          ...
          self.jQuerysubTotal[0].innerHTML =
    ...
    displayCart: function () {
      if (this.jQueryformCart.length) {
        ...
        if (items.length == 0) {
          this.jQuerysubTotal[0].innerHTML = this.currency + " " + 0.0;
        } else {
      ...
      if (self.jQueryupdateCartBtn.length) {
        self.jQueryupdateCartBtn.on("click", function () {
          ...
          jQueryrows.each(function () {
            ...
            var pqty = self._convertString(
              jQueryrow.find(".pqty > .qty").val()
            );
            var pprice = self._convertString(
              self._extractPrice(jQueryrow.find(".pprice"))
            );
